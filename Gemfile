...
gem 'public_suffix',      '~> 2.0'   if RUBY_VERSION >= '2.0.0' && RUBY_VERSION < '2.1'
gem 'public_suffix',      '1.4.6'    if RUBY_VERSION >= '1.9.3' && RUBY_VERSION < '2.0'
gem 'json',               '<= 1.8'   if RUBY_VERSION < '2.0.0'
gem 'json_pure',          '<= 2.0.1' if RUBY_VERSION < '2.0.0'
gem 'metadata-json-lint', '0.0.11'   if RUBY_VERSION < '1.9'
gem 'metadata-json-lint', '< 1.0'    if RUBY_VERSION >= '1.9' && RUBY_VERSION < '2.0'
